...
During loading, empty rows and columns are removed because they do not contribute meaningful information to the projected graphs. Basic statistics and the cleaned matrix visualization are provided in the notebook, while Figure~\ref{fig:original-matrix} gives a compact view of the original matrix and the two projections.
